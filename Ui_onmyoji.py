...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.mitama_click_partner = QtWidgets.QCheckBox(self.tab)
        self.mitama_click_partner.setObjectName("mitama_click_partner")
        self.gridLayout.addWidget(self.mitama_click_partner, 1, 0, 1, 3)
        self.mitama_dual = QtWidgets.QRadioButton(self.groupBox)
        self.mitama_dual.setObjectName("mitama_dual")
        self.gridLayout.addWidget(self.mitama_dual, 2, 0, 1, 1)
