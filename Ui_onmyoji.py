...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.mitama_click_partner_left = QtWidgets.QRadioButton(self.groupBox_5)
        self.mitama_click_partner_left.setObjectName("mitama_click_partner_left")
        self.gridLayout_12.addWidget(self.mitama_click_partner_left, 1, 0, 1, 1)
        self.mitama_click_partner_right = QtWidgets.QRadioButton(self.groupBox_5)
        self.mitama_click_partner_right.setObjectName("mitama_click_partner_right")
        self.gridLayout_12.addWidget(self.mitama_click_partner_right, 1, 1, 1, 1)
        self.mitama_dual = QtWidgets.QRadioButton(self.groupBox)
        self.mitama_dual.setObjectName("mitama_dual")
        self.gridLayout.addWidget(self.mitama_dual, 3, 0, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.lineEdit_5, 2, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.lineEdit_6, 3, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.lineEdit_7, 4, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "是否开启自动点选式神，乘客或者司机一人勾选即可。"))
        self.mitama_click_partner_left.setText(_translate("MainWindow", "点选最左边"))
        self.mitama_click_partner_right.setText(_translate("MainWindow", "点选最右边"))
        ...
        # 关于
        self.plainTextEdit.setPlainText(_translate("MainWindow", "开始专项任务前记得检查\n"
                                                                "\n"
                                                                 "检查御魂，检查阴阳师，检查页面选择状态"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "专项任务"))
        self.label_7.setText(_translate("MainWindow", "探索任务次数："))
        self.lineEdit_4.setText(_translate("MainWindow", "7"))
        self.label_8.setText(_translate("MainWindow", "御魂任务次数："))
        self.lineEdit_5.setText(_translate("MainWindow", "3"))
        self.label_9.setText(_translate("MainWindow", "觉醒任务次数："))
        self.lineEdit_6.setText(_translate("MainWindow", "3"))
        self.label_10.setText(_translate("MainWindow", "突破任务次数："))
